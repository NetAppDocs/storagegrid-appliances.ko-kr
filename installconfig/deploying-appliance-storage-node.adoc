...
.다음 단계
link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["그리드 구성 및 설치 완료"^]와 link:monitoring-appliance-installation.html["어플라이언스 설치 모니터링"]에 대해 알아보세요.
