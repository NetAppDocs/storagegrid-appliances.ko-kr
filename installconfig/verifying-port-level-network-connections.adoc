...
또한 외부 NFS 또는 DNS 서버에 사용되는 것과 같은 UDP 포트와 Admin 및 Client Networks에서 연결을 테스트할 수 있습니다. 이러한 포트 목록은 를 참조하십시오 https://docs.netapp.com/us-en/storagegrid-118/network/network-port-reference.html["네트워크 포트 참조"^].
