...
* 있습니다 link:power-sg110-and-sg1100-off-on.html#shut-down-the-appliance["SG110 또는 SG1100을 종료합니다"].
+
...
.작업을 마친 후
link:power-sg110-and-sg1100-off-on.html#power-on-sg110-or-sg1100-and-verify-operation.html["어플라이언스를 다시 시작하십시오"].
