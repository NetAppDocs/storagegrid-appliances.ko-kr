...
---
= SG110 또는 SG1100에서 CMOS 배터리를 교체합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.시작하기 전에
* 있습니다 link:verify-component-to-replace.html["CMOS 배터리를 교체해야 하는 SG110 또는 SG1100을 확인했습니다"].
* 있습니다 link:locating-sg110-and-sg1100-in-data-center.html["SG110 또는 SG1100 어플라이언스를 실제로 찾았습니다"] 데이터 센터의 CMOS 배터리를 교체하는 위치입니다.
+
