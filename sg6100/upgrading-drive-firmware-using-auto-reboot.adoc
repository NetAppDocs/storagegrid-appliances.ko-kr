...
---
= 어플라이언스 재부팅 중 SG6160 드라이브 펌웨어를 자동으로 업그레이드합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 동안link:../sg6100/upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["SANtricity OS 업그레이드"] 유지 관리 모드 사용
