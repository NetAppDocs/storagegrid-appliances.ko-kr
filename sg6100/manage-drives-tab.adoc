...
.시작하기 전에
* 를 사용하여 그리드 관리자에 로그인했습니다 https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/web-browser-requirements.html["지원되는 웹 브라우저"^].


.이 작업에 대해
SGF6112 어플라이언스와 이 있는 경우 https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/admin-group-permissions.html["스토리지 어플라이언스 관리자 또는 루트 액세스 권한"]어플라이언스 세부 정보 페이지에 드라이브 관리 탭이 나타납니다.
