...
---
= Grid Manager를 사용하여 SG6160 스토리지 컨트롤러에서 SANtricity OS를 업그레이드합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["유지보수 모드를 사용하여 SG6160 컨트롤러에서 SANtricity OS를 업그레이드합니다"]
