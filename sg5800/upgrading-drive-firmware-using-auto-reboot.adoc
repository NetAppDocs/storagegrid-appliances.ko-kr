...
---
= 어플라이언스 재부팅 중 SG5800 드라이브 펌웨어를 자동으로 업그레이드합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 동안link:../sg5800/upgrading-santricity-os-on-e4000-controller-using-maintenance-mode.html["SANtricity OS 업그레이드"] 유지 관리 모드 사용
