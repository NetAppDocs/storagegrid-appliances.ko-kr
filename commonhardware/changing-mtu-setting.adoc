...
.단계
IP 변경 도구에 액세스하여 에 설명된 대로 MTU 설정을 업데이트합니다 https://docs.netapp.com/us-en/storagegrid-118/maintain/changing-nodes-network-configuration.html["노드 네트워크 구성을 변경합니다"^].
