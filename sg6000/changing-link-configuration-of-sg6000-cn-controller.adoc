...
+
VLAN 설정을 변경한 경우 어플라이언스의 서브넷이 변경되었을 수 있습니다. 어플라이언스의 IP 주소를 변경해야 하는 경우 에 따르십시오 https://docs.netapp.com/us-en/storagegrid-118/maintain/configuring-ip-addresses.html["IP 주소를 구성합니다"^] 지침.
